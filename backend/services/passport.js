...
passport.use(new GoogleStrategy({
  ...
  async (req, accessToken, refreshToken, profile, done) => {
    try {
      ...
      const newUser = await db.query("INSERT INTO users (email, username, avatar, google_id) VALUES ($1, $2, $3, $4) RETURNING *", [profile.emails[0].value, 'google-user' + profile.displayName, profile.photos[0].value, profile.id]);
